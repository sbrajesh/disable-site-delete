...
That's right. Only network administrator can disable a blog.
...
Yes, there is a plugin by Ryan Hellyer [Delete Delete Site](http://wordpress.org/plugins/delete-delete-site/ "Delete Delete Site") but that only removes the menu link and does not actually prevent users from doing it completely.
